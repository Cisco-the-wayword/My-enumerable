...
>  **My Enumerable** In this project we learn how to use a module inside a class. For this we create a class my_list and a module my_enumerable. Our module My-enumerable implements a subset of the functionality of an Enumerable.
...
```sh
  cd my-folder
  git clone git@github.com:Cisco-the-wayword/My-enumerable.git
```
